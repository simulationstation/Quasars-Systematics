...
This document contains the long-form setup/run notes moved out of the top-level `README.md` to keep the
repository landing page short and referee-friendly.

For the primary story and the paper bundle, start with:
...
This uses the **Secrest footprint + ecliptic correction + fit_dipole linear solve** (matching the released
