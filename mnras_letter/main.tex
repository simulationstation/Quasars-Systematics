...
Thus, large analytic $\chi^2_D$ values from dipole-only recovery are not a calibrated test for time-variation when epoch-dependent systematics are present.
